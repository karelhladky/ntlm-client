import { NTLMFLAG_NEGOTIATE_OEM, NTLMFLAG_REQUEST_TARGET, NTLMFLAG_NEGOTIATE_NTLM_KEY, NTLMFLAG_NEGOTIATE_NTLM2_KEY, NTLMFLAG_NEGOTIATE_ALWAYS_SIGN, NTLMFLAG_NEGOTIATE_TARGET_INFO } from './flags';
import os from 'os';
import { createNTLMHash, createPseudoRandomValue, createLMv2Response, createNTLMv2Response, createLMHash, createLMResponse, createNTLMResponse } from './hash';
 ...
 */
export function createType1Message(workstation = undefined, target = undefined) {
    let dataPos = 32;
    let pos = 0;
 ...
 */
export function createType3Message(type2Message, username, password, workstation, target) {
    let dataPos = 52;
    const buf = Buffer.alloc(1024);
