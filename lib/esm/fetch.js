...
export class Fetch {
    ...
    static request(options) {
        log(this, options, 'request init for url: ' + (options === null || options === void 0 ? void 0 : options.url));
        const getProtocol = (url) => (url === null || url === void 0 ? void 0 : url.startsWith('https://')) ? https : http;
    ...
    static get(options, protocol, res, rej) {
        ...
        if (options.requests > RECURSIVE_LIMIT) {
        ...
        try {
            ...
            const req = protocol.request(options.url, options, (response) => {
                ...
                log(this, options, 'response ' + (response === null || response === void 0 ? void 0 : response.statusCode) + ' from ' + options.url);
    ...
    static executeNTLM2(result, options, response, protocol, res, rej) {
        ...
        const authHeader = createType3Message(t2m, (options === null || options === void 0 ? void 0 : options.user) || '', (options === null || options === void 0 ? void 0 : options.pwd) || '', options === null || options === void 0 ? void 0 : options.workstation, options === null || options === void 0 ? void 0 : options.domain);
    ...
    static executeBasic(options, protocol, res, rej) {
        ...
        options.headers = options.headers || {};
        options.headers['Authorization'] = createBasicMessage((options === null || options === void 0 ? void 0 : options.user) || '', (options === null || options === void 0 ? void 0 : options.pwd) || '');
        Fetch.deleteCredentials(options);
        Fetch.get(options, protocol, res, rej);
    }
    /**
    ...
    static getAuthMethods(result, response, options) {
        ...
        log(this, options, 'www-authenticate header = ' + ((_a = response.headers) === null || _a === void 0 ? void 0 : _a['www-authenticate']));
